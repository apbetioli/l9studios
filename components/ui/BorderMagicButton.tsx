...
export default function BorderMagicButton({
  ...
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-950 px-3 py-1 font-medium text-white backdrop-blur-3xl">
        {children}
      </span>
    </button>
  )
