  ...
  if (Math.fround && -1 == browser.indexOf('Chrome')) LoadJSCodeBlob(o, t)
    ...
    ;(n.onload = function (e) {
      var o = e.target.result.replace(/Math_fround\(/g, '('),
        n = new Blob([o], { type: 'text/javascript' })
      LoadJSCodeBlob(n, t)
    }),
      n.readAsText(o)
  }
  ...
  LoadCompressedFile(e, o, function (o) {
    ...
    if ((o.total && (a = o.total), o.loaded)) {
      Module.dataFileDownloads || (Module.dataFileDownloads = {}),
        (Module.dataFileDownloads[n] = { loaded: o.loaded, total: a })
      var i = 0,
        r = 0,
        s = 0
      ...
      ;(i = Math.ceil((i * Module.expectedDataFileDownloads) / s)),
        Module.setStatus &&
          Module.setStatus('Downloading data... (' + r + '/' + i + ')')
    } else
    ...
    })(
      {
            ...
            var a = {
                arraySet: function (e, t, o, n, a) {
                  if (t.subarray && e.subarray)
                    return void e.set(t.subarray(o, o + n), a)
                ...
                flattenChunks: function (e) {
                  ...
                  for (
                    r = new Uint8Array(n), a = 0, t = 0, o = e.length;
                    o > t;
                    t++
                  )
                    (i = e[t]), r.set(i, a), (a += i.length)
                  return r
                },
              },
              i = {
        ...
        2: [
          function (e, t, o) {
            'use strict'
            function n(e, t) {
              if (65537 > t && ((e.subarray && r) || (!e.subarray && i)))
            ...
            for (var l = new a.Buf8(256), d = 0; 256 > d; d++)
              l[d] =
                d >= 252
                  ? 6
                  : d >= 248
            ...
            ;(l[254] = l[254] = 1),
                ...
                for (i = 0; s > i; i++)
                  (o = e.charCodeAt(i)),
                    55296 === (64512 & o) &&
                      ...
                      ((n = e.charCodeAt(i + 1)),
                      56320 === (64512 & n) &&
                        ((o = 65536 + ((o - 55296) << 10) + (n - 56320)), i++)),
                    (l += 128 > o ? 1 : 2048 > o ? 2 : 65536 > o ? 3 : 4)
                for (t = new a.Buf8(l), r = 0, i = 0; l > r; i++)
                  (o = e.charCodeAt(i)),
                    55296 === (64512 & o) &&
                      s > i + 1 &&
                      ((n = e.charCodeAt(i + 1)),
              ...
              (o.binstring2buf = function (e) {
                for (
                  var t = new a.Buf8(e.length), o = 0, n = t.length;
                  n > o;
                  o++
                )
                  t[o] = e.charCodeAt(o)
              ...
              (o.utf8border = function (e, t) {
                var o
                for (
                  t = t || e.length, t > e.length && (t = e.length), o = t - 1;
                  o >= 0 && 128 === (192 & e[o]);
        ...
        3: [
          function (e, t, o) {
            ...
            function n(e, t, o, n) {
              for (
                var a = (65535 & e) | 0, i = ((e >>> 16) & 65535) | 0, r = 0;
                0 !== o;

              ) {
                ;(r = o > 2e3 ? 2e3 : o), (o -= r)
                do (a = (a + t[n++]) | 0), (i = (i + a) | 0)
                while (--r)
                ;(a %= 65521), (i %= 65521)
              }
              return a | (i << 16) | 0
          ...
          function (e, t, o) {
            ...
            function c(e, t, o, n) {
              ...
              return (
                ...
                n >= i.wsize
                  ? (b.arraySet(i.window, t, o - i.wsize, i.wsize, 0),
                    (i.wnext = 0),
                    (i.whave = i.wsize))
                  : ((a = i.wsize - i.wnext),
                    a > n && (a = n),
                    b.arraySet(i.window, t, o - n, a, i.wnext),
                    (n -= a),
                    n
                      ? (b.arraySet(i.window, t, o - n, n, 0),
                        (i.wnext = n),
                        (i.whave = i.wsize))
                      : ((i.wnext += a),
                ...
                switch (o.mode) {
                  ...
                  case q:
                    if (
                      ...
                      w &&
                        (o.head &&
                          ((_e = o.head.extra_len - o.length),
                          o.head.extra ||
                            (o.head.extra = new Array(o.head.extra_len)),
                          b.arraySet(o.head.extra, a, r, w, _e)),
                        512 & o.flags && (o.check = v(o.check, a, w, r)),
                        (l -= w),
                        (r += w),
                        (o.length -= w)),
                      o.length)
                      ...
                      do
                        (_e = a[r + w++]),
                          o.head &&
                            _e &&
                            o.length < 65536 &&
                            (o.head.name += String.fromCharCode(_e))
                      while (_e && l > w)
                      if (
                        (512 & o.flags && (o.check = v(o.check, a, w, r)),
                        (l -= w),
                      ...
                      do
                        (_e = a[r + w++]),
                          o.head &&
                            _e &&
                            o.length < 65536 &&
                            (o.head.comment += String.fromCharCode(_e))
                      while (_e && l > w)
                      if (
                        (512 & o.flags && (o.check = v(o.check, a, w, r)),
                        (l -= w),
                  ...
                  case $:
                    ...
                    if (
                      ...
                      (o.lenbits = 7),
                      (Se = { bits: o.lenbits }),
                      (xe = y(_, o.lens, 0, 19, o.lencode, 0, o.work, Se)),
                      (o.lenbits = Se.bits),
                      xe)
                    ) {
                  ...
                  case ee:
                    ...
                    if (
                      ((o.lenbits = 9),
                      (Se = { bits: o.lenbits }),
                      (xe = y(x, o.lens, 0, o.nlen, o.lencode, 0, o.work, Se)),
                      (o.lenbits = Se.bits),
                      xe)
                    ) {
                  ...
                  case ae:
                    for (
                      ;
                      (Ce = o.distcode[f & ((1 << o.distbits) - 1)]),
                        (we = Ce >>> 24),
                        (be = (Ce >>> 16) & 255),
                        (ge = 65535 & Ce),
                        !(h >= we);
                ...
                c(e, e.output, e.next_out, m - e.avail_out)
                  ...
                  : ((p -= e.avail_in),
                    ...
                    o.wrap &&
                      ...
                      (e.adler = o.check =
                        o.flags
                          ? v(o.check, i, m, e.next_out - m)
                          : g(o.check, i, m, e.next_out - m)),
                    (e.data_type =
                      o.bits +
                      (o.last ? 64 : 0) +
                      (o.mode === J ? 128 : 0) +
                      (o.mode === te || o.mode === X ? 256 : 0)),
                    ((0 === p && 0 === m) || t === M) && xe === R && (xe = B),
                    xe)
              )
            }
            function h(e) {
            ...
            function p(e, t) {
              ...
              return e && e.state
                ? ((o = e.state),
                  0 === (2 & o.wrap) ? L : ((o.head = t), (t.done = !1), R))
                : L
            }
            var m,
              w,
            ...
            ;(o.inflateReset = r),
              (o.inflateReset2 = s),
              (o.inflateResetKeep = i),
              (o.inflateInit = d),
              (o.inflateInit2 = l),
              (o.inflate = f),
              (o.inflateEnd = h),
              (o.inflateGetHeader = p),
          ...
          function (e, t, o) {
            ...
            t.exports = function (e, t, o, p, m, w, b, g) {
              ...
              for (var H = 0; ; ) {
                ...
                if (F > z && (T & _) !== y) {
                  for (
                    0 === I && (I = z), x += L, B = F - I, U = 1 << B;
                    A > B + I && ((U -= q[B + I]), !(0 >= U));

                  )
                    B++, (U <<= 1)
                  if (((O += 1 << B), (e === l && O > i) || (e === d && O > r)))
                    return 1
                  ;(y = T & _), (m[y] = (z << 24) | (B << 16) | (x - w) | 0)
                }
              }
              return (
                0 !== T && (m[x + T] = ((F - I) << 24) | (64 << 16) | 0),
                (g.bits = z),
                0
              )
            }
              ...
              do {
                if (
                  (0 === c.avail_out &&
                    ...
                    (c.next_out = 0),
                    (c.avail_out = h)),
                  (o = i.inflate(c, l.Z_NO_FLUSH)),
                  o !== l.Z_STREAM_END && o !== l.Z_OK)
                )
                ...
                c.next_out &&
                  ...
                  ('string' === this.options.to
                    ? ((a = s.utf8border(c.output, c.next_out)),
                      (d = c.next_out - a),
                      (u = s.buf2string(c.output, a)),
                      (c.next_out = d),
                      (c.avail_out = h - d),
                      d && r.arraySet(c.output, c.output, a, d, 0),
                      this.onData(u))
                    : this.onData(r.shrinkBuf(c.output, c.next_out)))
              } while (c.avail_in > 0 && o !== l.Z_STREAM_END)
              return (
                o === l.Z_STREAM_END && (n = l.Z_FINISH),
                n === l.Z_FINISH
                  ? ((o = i.inflateEnd(this.strm)),
                    this.onEnd(o),
                    (this.ended = !0),
                    o === l.Z_OK)
                  : n === l.Z_SYNC_FLUSH
...
var browser = (function () {
    ...
    return /trident/i.test(o[1])
      ...
      : 'Chrome' === o[1] && ((e = t.match(/\bOPR\/(\d+)/)), null != e)
        ? 'Opera ' + e[1]
        : ((o = o[2]
            ? [o[1], o[2]]
...
'function' != typeof window.onerror &&
  (window.onerror = function (e, t, o) {
    return (Module.errorhandler && Module.errorhandler(e, t, o)) ||
    ...
    var e = function (e) {
      ...
      function o() {
        ...
        function o(o) {
          ...
          ;(t.prototype.byteArray = n),
            t.prototype.requests['/globalgamemanagers'].onload(),
            t.prototype.requests['/globalgamemanagers.assets'].onload(),
            t.prototype.requests['/level0'].onload(),
            t.prototype.requests['/methods_pointedto_by_uievents.xml'].onload(),
            t.prototype.requests['/preserved_derived_types.xml'].onload(),
            t.prototype.requests['/sharedassets0.assets'].onload(),
            t.prototype.requests['/sharedassets0.resource'].onload(),
            t.prototype.requests[
              '/Il2CppData/Metadata/global-metadata.dat'
            ].onload(),
            t.prototype.requests['/Resources/unity_default_resources'].onload(),
            t.prototype.requests['/Resources/unity_builtin_extra'].onload(),
            t.prototype.requests['/Managed/mono/2.0/machine.config'].onload(),
            Module.removeRunDependency('datafile_forestfortress.data')
        }
        Module.FS_createPath('/', 'Il2CppData', !0, !0),
          ...
          new t(0, 25172, 0, 0).open('GET', '/globalgamemanagers'),
          new t(25172, 48020, 0, 0).open('GET', '/globalgamemanagers.assets'),
          new t(48020, 3121640, 0, 0).open('GET', '/level0'),
          new t(3121640, 3121661, 0, 0).open(
            'GET',
            '/methods_pointedto_by_uievents.xml',
          ),
          new t(3121661, 3126646, 0, 0).open(
            'GET',
            '/preserved_derived_types.xml',
          ),
          new t(3126646, 30530138, 0, 0).open('GET', '/sharedassets0.assets'),
          new t(30530138, 31831978, 0, 0).open(
            'GET',
            '/sharedassets0.resource',
          ),
          new t(31831978, 33673062, 0, 0).open(
            'GET',
            '/Il2CppData/Metadata/global-metadata.dat',
          ),
          new t(33673062, 35170434, 0, 0).open(
            'GET',
            '/Resources/unity_default_resources',
          ),
          new t(35170434, 35231162, 0, 0).open(
            'GET',
            '/Resources/unity_builtin_extra',
          ),
          new t(35231162, 35258787, 0, 0).open(
            'GET',
            '/Managed/mono/2.0/machine.config',
          ),
          Module.addRunDependency('datafile_forestfortress.data'),
      ...
      var a = 'forestfortress.data',
        i = 'forestfortress.data'
