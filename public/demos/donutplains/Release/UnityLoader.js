  ...
  LoadCompressedFile(e, n, function (n) {
    ...
    if ((n.total && (a = n.total), n.loaded)) {
      Module.dataFileDownloads || (Module.dataFileDownloads = {}),
        (Module.dataFileDownloads[o] = { loaded: n.loaded, total: a })
      var i = 0,
        r = 0,
        s = 0
            ...
            var a = {
                arraySet: function (e, t, n, o, a) {
                  if (t.subarray && e.subarray)
                    return void e.set(t.subarray(n, n + o), a)
                ...
                flattenChunks: function (e) {
                  ...
                  for (
                    r = new Uint8Array(o), a = 0, t = 0, n = e.length;
                    n > t;
                    t++
                  )
          ...
          function (e, t, n) {
            ...
            ;(l[254] = l[254] = 1),
              ...
              (n.binstring2buf = function (e) {
                for (
                  var t = new a.Buf8(e.length), n = 0, o = t.length;
                  o > n;
                  n++
                )
                  t[n] = e.charCodeAt(n)
          ...
          function (e, t, n) {
            ...
            function c(e, t, n, o) {
              ...
              return (
                ...
                o >= i.wsize
                  ? (b.arraySet(i.window, t, n - i.wsize, i.wsize, 0),
                    (i.wnext = 0),
                    (i.whave = i.wsize))
                  : ((a = i.wsize - i.wnext),
                    a > o && (a = o),
                    b.arraySet(i.window, t, n - o, a, i.wnext),
                    (o -= a),
                    o
                      ? (b.arraySet(i.window, t, n - o, o, 0),
                        (i.wnext = o),
                        (i.whave = i.wsize))
                      : ((i.wnext += a),
                    ...
                    if (
                      ...
                      w &&
                        (n.head &&
                          ...
                          b.arraySet(n.head.extra, a, r, w, _e)),
                        512 & n.flags && (n.check = v(n.check, a, w, r)),
                        (l -= w),
                        (r += w),
                        (n.length -= w)),
                      n.length)
            ...
            function p(e, t) {
              ...
              return e && e.state
                ? ((n = e.state),
                  0 === (2 & n.wrap) ? L : ((n.head = t), (t.done = !1), R))
                : L
            }
            var m,
              w,
          ...
          function (e, t, n) {
            ...
            t.exports = function (e, t, n, p, m, w, b, g) {
              var v,
                ...
                j = 0
              for (D = 0; a >= D; D++) q[D] = 0
              for (F = 0; p > F; F++) q[t[n + F]]++
              for (z = R, A = a; A >= 1 && 0 === q[A]; A--);
              if ((z > A && (z = A), 0 === A))
                return (m[w++] = 20971520), (m[w++] = 20971520), (g.bits = 1), 0
              for (L = 1; A > L && 0 === q[L]; L++);
              for (L > z && (z = L), U = 1, D = 1; a >= D; D++)
                if (((U <<= 1), (U -= q[D]), 0 > U)) return -1
              if (U > 0 && (e === s || 1 !== A)) return -1
              for (N[1] = 0, D = 1; a > D; D++) N[D + 1] = N[D] + q[D]
              for (F = 0; p > F; F++) 0 !== t[n + F] && (b[N[t[n + F]]++] = F)
              if (
                (e === s
                  ? ((P = G = b), (S = 19))
                  : e === l
                    ? ((P = u), (Z -= 257), (G = c), (j -= 257), (S = 256))
                    : ((P = f), (G = h), (S = -1)),
                (T = 0),
                (F = 0),
                (D = L),
      ...
      function n() {
        ...
        function n(n) {
          ...
          ;(t.prototype.byteArray = o),
            ...
            Module.removeRunDependency('datafile_Donut Plains.data')
        }
        Module.FS_createPath('/', 'Il2CppData', !0, !0),
          ...
          new t(0, 25164, 0, 0).open('GET', '/globalgamemanagers'),
          new t(25164, 48012, 0, 0).open('GET', '/globalgamemanagers.assets'),
          new t(48012, 176788, 0, 0).open('GET', '/level0'),
          new t(176788, 176809, 0, 0).open(
            'GET',
            '/methods_pointedto_by_uievents.xml',
          ),
          new t(176809, 181794, 0, 0).open(
            'GET',
            '/preserved_derived_types.xml',
          ),
          new t(181794, 37161626, 0, 0).open('GET', '/sharedassets0.assets'),
          new t(37161626, 38067243, 0, 0).open(
            'GET',
            '/sharedassets0.resource',
          ),
          new t(38067243, 39908327, 0, 0).open(
            'GET',
            '/Il2CppData/Metadata/global-metadata.dat',
          ),
          new t(39908327, 41405699, 0, 0).open(
            'GET',
            '/Resources/unity_default_resources',
          ),
          new t(41405699, 41466427, 0, 0).open(
            'GET',
            '/Resources/unity_builtin_extra',
          ),
          new t(41466427, 41494052, 0, 0).open(
            'GET',
            '/Managed/mono/2.0/machine.config',
          ),
          Module.addRunDependency('datafile_Donut Plains.data'),
